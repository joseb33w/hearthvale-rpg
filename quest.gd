...
## satisfied, grants rewards, and SETS FLAGS that gate seams. Collect objectives auto-update
## from RpgState.changed; kills come via notify_kill(). This flag-gating is exactly what
